...
export const metadata: Metadata = {
  title: 'Seller · Maiplot',
};

/** Placeholder landing for a signed-in seller. The full seller onboarding +
...
export default function SellerHomePage() {
  ...
  return (
    <main className="mx-auto max-w-md px-6 py-24 text-center">
      <p className="text-xs uppercase tracking-[0.2em] text-ink-300">Seller</p>
      <h1 className="mt-2 font-display text-3xl text-ink-900">You&rsquo;re signed in</h1>
      <p className="mt-3 text-sm text-ink-500">
        Your seller workspace — listing creation, documents, and offers — is coming next.
      </p>
    </main>
  );
}
