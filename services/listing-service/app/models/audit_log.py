...
triggers enforcing append-only. listing-service does NOT create the table —
it only maps this ORM onto the shared table to INSERT rows (e.g.
listing.approved / listing.rejected). The repository never updates or
deletes, so the triggers are never tripped.
"""
