...
realtor-service does not own or migrate audit_log — it only INSERTs, the
shared-DB pattern used by the other services. Every realtor approval decision is
recorded here (SCRUM-71).
"""
