...
analytics-service consumes access tokens minted by auth-service; it never issues
them. Verifies the HS256 signature, issuer, and expiry, enforces type=access, and
returns the user_id + role for authorization. Mirrors the decode half of
auth-service's JwtService.
"""
